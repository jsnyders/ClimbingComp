...
function addResources(server, dbPool) {
    ...
    server.put("data/events/:eventId/results/:bibNumber", function(req,res,next) {
        var eventId = conv.convertToIntegerId(req.params.eventId),
            bibNumber = conv.convertToIntegerId(req.params.climberId),
            input = req.body;
    ...
    var eventResultSQL =
        "SELECT bib_number, usac_member_id, first_name, last_name, ec.gender, ec.category, birth_date, region, team, scored_by, scored_on, " +
